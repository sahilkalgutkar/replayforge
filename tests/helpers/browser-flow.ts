...
import type { Observation, Primitive, TargetSpec } from '../../src/surface/types.js';

// Small helpers so tests drive the demo app by semantic target, the same way a
// recorded flow will.

export async function act(
  surface: BrowserSurface,
  spec: TargetSpec,
  make: (ref: string) => Primitive,
): Promise<Observation> {
...
export async function signOnInBrowser(
  surface: BrowserSurface,
  baseUrl: string,
): Promise<Observation> {
