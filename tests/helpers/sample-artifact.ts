...
// A hand-written capability for the tests, shaped the way a discovery run will
// produce one. Tests build from this so they stay deterministic.
    ...
    steps: [
      ...
      },
      {
        ...
        action: {
          kind: 'type',
          target: {
            description: 'the user id field, found by the "User ID" label in the cell beside it',
      ...
      },
      {
        ...
        action: {
          kind: 'type',
          target: {
            description: 'the password field, found by the "Password" label in the cell beside it',
      ...
      },
      {
        ...
        action: {
          ...
          target: {
            ...
            fallbacks: [{ role: 'link', name: { mode: 'contains', value: 'Search' }, framePath: ['navFrame'] }],
          },
        },
        risk: 'safe',
        guards: [
      ...
      },
      {
        ...
        action: {
          kind: 'type',
          target: {
            description: 'the member number field, found by the label in the cell to its left',
            primary: {
              role: 'textbox',
              editable: true,
              nearbyText: { mode: 'contains', value: 'Member Number' },
      ...
      },
      {
        ...
        action: {
          ...
          target: {
            description:
              'the Current Balance cell of the Regular Savings row, addressed by row key and column header rather than position',
            primary: {
              role: 'cell',
              framePath: ['mainFrame'],
              inTable: {
    ...
    outcomes: [
      {
        ...
        description: 'The core holds no member with that number. A real answer, not a failure.',
